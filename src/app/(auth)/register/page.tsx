      ...
      <div className="w-full lg:w-[420px] flex-shrink-0 flex flex-col p-8 sm:p-12">
        <div className="mb-12">
          ...
          <p className="text-sm text-gray-500 font-medium">
            Already have an Empire of Forex account? <Link href="/login" className="text-gray-900 border-b-2 border-gray-900 font-bold ml-1">Sign In</Link>
          </p>
        </div>
        ...
        <div className="relative z-10 p-20 h-full flex flex-col justify-start">
          ...
          >
            ...
            <p className="text-xl font-medium opacity-90 mb-8 leading-normal">
              Join Empire of Forex and access the best <br />
              trading and investment tools in the global market.
            </p>
            <Link 
              href="/register" 
