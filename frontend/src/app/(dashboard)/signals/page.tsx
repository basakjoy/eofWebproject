...
export default function SignalsPage() {
  ...
  return (
    <div className="space-y-6 p-2 sm:p-4 text-white font-poppins selection:bg-fiery-orange selection:text-white">
        ...
        {[
          ...
          <div key={label} className="bg-card-dark/70 border border-white/10 rounded-2xl p-4 flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="text-lg font-black text-white">{loading ? '—' : value}</p>
            </div>
          </div>
        ))}
      </div>

      {/* ══ SEARCH, VIEW SWITCHER & FILTER TABS ══ */}
      <div className="bg-card-dark/60 rounded-2xl border border-white/10 p-3 space-y-3">
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
          ...
          {/* View Mode Toggle */}
          <div className="flex items-center gap-1 bg-panel-dark p-1 rounded-xl border border-white/10 self-start sm:self-auto">
            <button
      ...
      {viewMode === 'analytics' ? (
          ...
          {filteredSignals.map((signal) => {
            ...
            return (
              <div
                ...
                className={`group relative bg-card-dark/70 backdrop-blur-xl border rounded-3xl p-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl cursor-pointer overflow-hidden ${
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <h3 className="text-base font-extrabold text-white">{signal.pair}</h3>
        ...
        /* TABLE / TERMINAL VIEW */
        <div className="bg-card-dark/60 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden">
